...
module "openvpn" {
  ...
  private-route_table            = data.terraform_remote_state.vpc.outputs.vpc_private_route_table
  public-route_table             = data.terraform_remote_state.vpc.outputs.vpc_public_route_table
  # Route 53
